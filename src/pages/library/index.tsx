        ...
        <div className="p-4">
          ...
          <form onSubmit={handleCreatePlaylist}>
            <input
              ...
              className="w-full px-3 py-2.5 sm:px-2 sm:py-1 text-base sm:text-xs bg-black/20 border border-white/5 rounded text-white placeholder-white/40 focus:outline-none focus:border-gold/50"
